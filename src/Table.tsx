...
function MyTable() {
            ...
            <IndeterminateCheckbox
              {...{
                ...
                onChange: (e) => {
                  ...
                  if (!shiftKey) {
                    console.log("set id", row.id);
                    setLastSelectedRow(row.id);
                  } else {
                    console.log("selected ind", lastSelectedRow);
                    console.log("row", row.id);
                  }
                  /* console.log("shift down", shiftKey);
  ...
  console.log("last row", lastSelectedRow);
  return (
    <div className="p-2">
      <pre>{JSON.stringify(lastSelectedRow, null, 2)}</pre>
      <div>
        <input
          value={globalFilter ?? ""}
